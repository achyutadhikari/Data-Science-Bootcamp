...
class absenteeism_model():
    ...
    def load_and_clean_data(self, data_file):
        ...
        # to preserve the code we have created in the revious section, we will add a column with NaN strings
        df['Absenteeism in Hours'] = 'NaN'
        
        # create a separate dataframe, containing dummy values for ALL avaialable reasons
        ...
        #note there ia a more universal versio of this code, however the following will best suit our purposes
        ...
        column_names_upd = ['Reason_1', 'Reason_2', 'Reason_3', 'Reason_4',
               'Month Value','Day of week','Transportation Expense', 'Distance to Work', 'Age',
               'Daily Work Load Average', 'Body Mass Index', 'Education',
               'Children', 'Pets', 'Absenteeism Time in Hours']
